          ...
          >
            <ol className="bg-base bg-op-70! backdrop-blur-md p-2 rounded-lg color-base text-base">
              ...
              <li className="flex gap-2 items-center">
                <a
                  href="https://github.com/imxv/newsnow-plus"
                >
                  <img
                    alt="GitHub stars badge"
                    src="https://img.shields.io/github/stars/imxv/newsnow-plus?logo=github&style=flat&labelColor=%235e3c40&color=%23614447"
                  />
                </a>
                <a
                  href="https://github.com/imxv/newsnow-plus/fork"
                >
                  <img
                    alt="GitHub forks badge"
                    src="https://img.shields.io/github/forks/imxv/newsnow-plus?logo=github&style=flat&labelColor=%235e3c40&color=%23614447"
                  />
                </a>
              </li>
            </ol>
